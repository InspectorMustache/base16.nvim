" Base16 Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox) (https://github.com/chriskempson/base16)
...
" Tell them our name.
let g:colors_name = 'gruvbox-light-medium'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('gruvbox-light-medium', '-', '_', 'g').'_'.&background
  let g:airline#themes#{s:palette}#palette = {}
  function! s:airlist(fg, bg)
    return [
          \ g:base16_hex_colors[a:fg],
          \ g:base16_hex_colors[a:bg],
          \ g:base16_cterm_colors[a:fg],
  ...
  let g:airline#themes#{s:palette}#palette.accents = {
          \ 'red': s:airlist('red', 'red'),
          \ 'green': s:airlist('green', 'green'),
          \ 'blue': s:airlist('blue', 'blue'),
          \ 'yellow': s:airlist('yellow', 'yellow'),
          \ 'orange': s:airlist('orange', 'orange'),
          \ 'purple': s:airlist('purple', 'purple')}

  call airline#switch_theme(s:palette)
  unlet s:palette
  delfunction s:airlist
endif
