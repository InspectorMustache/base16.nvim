" Base16 Stephan Boyer (https://github.com/stepchowfun) and Esther Wang (https://github.com/ewang12) (https://github.com/chriskempson/base16)
" Scheme: Circus
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('circus', '-', '_', 'g').'_'.&background
