" Base16 Jay Cornwall (https://jcornwall.com) (https://github.com/chriskempson/base16)
" Scheme: Woodland
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('woodland', '-', '_', 'g').'_'.&background
