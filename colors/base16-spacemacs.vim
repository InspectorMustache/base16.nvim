" Base16 Nasser Alshammari (https://github.com/nashamri/spacemacs-theme) (https://github.com/chriskempson/base16)
" Scheme: Spacemacs
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('spacemacs', '-', '_', 'g').'_'.&background
