" Base16 Ethan Schoonover (http://ethanschoonover.com/solarized) (https://github.com/chriskempson/base16)
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('solarized-light', '-', '_', 'g').'_'.&background
