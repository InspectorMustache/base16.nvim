" Base16 Josh W Lewis (@joshwlewis) (https://github.com/chriskempson/base16)
...
" Tell them our name.
let g:colors_name = 'unikitty-light'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('unikitty-light', '-', '_', 'g').'_'.&background
