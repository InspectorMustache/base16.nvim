" Base16 Timothée Poisot (http://github.com/tpoisot) (https://github.com/chriskempson/base16)
" Scheme: Brewer
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('brewer', '-', '_', 'g').'_'.&background
