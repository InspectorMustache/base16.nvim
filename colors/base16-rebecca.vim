" Base16 Victor Borja (http://github.com/vic) based on Rebecca Theme (http://github.com/vic/rebecca-theme) (https://github.com/chriskempson/base16)
" Scheme: Rebecca
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('rebecca', '-', '_', 'g').'_'.&background
