" Base16 Jason Heeris (http://heeris.id.au) (https://github.com/chriskempson/base16)
...
" Tell them our name.
let g:colors_name = 'classic-light'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('classic-light', '-', '_', 'g').'_'.&background
