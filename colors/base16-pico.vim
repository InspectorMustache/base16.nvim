" Base16 PICO-8 (http://www.lexaloffle.com/pico-8.php) (https://github.com/chriskempson/base16)
" Scheme: Pico
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('pico', '-', '_', 'g').'_'.&background
