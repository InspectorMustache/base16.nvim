" Base16 Rebecca Bettencourt (http://www.kreativekorp.com) (https://github.com/chriskempson/base16)
" Scheme: Macintosh
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('macintosh', '-', '_', 'g').'_'.&background
