" Base16 Jannik Siebert (https://github.com/janniks) (https://github.com/chriskempson/base16)
...
" Tell them our name.
let g:colors_name = 'harmonic-light'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('harmonic-light', '-', '_', 'g').'_'.&background
