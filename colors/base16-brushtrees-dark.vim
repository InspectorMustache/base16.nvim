" Base16 Abraham White &lt;abelincoln.white@gmail.com&gt; (https://github.com/chriskempson/base16)
...
" Tell them our name.
let g:colors_name = 'brushtrees-dark'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('brushtrees-dark', '-', '_', 'g').'_'.&background
