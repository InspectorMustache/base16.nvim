" Base16 Tyler Benziger (http://tybenz.com) (https://github.com/chriskempson/base16)
" Scheme: Shapeshifter
...
" Tell them our name.
let g:colors_name = 'shapeshifter'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('shapeshifter', '-', '_', 'g').'_'.&background
