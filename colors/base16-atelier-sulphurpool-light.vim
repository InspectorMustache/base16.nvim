" Base16 Bram de Haan (http://atelierbramdehaan.nl) (https://github.com/chriskempson/base16)
...
" Tell them our name.
let g:colors_name = 'atelier-sulphurpool-light'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('atelier-sulphurpool-light', '-', '_', 'g').'_'.&background
