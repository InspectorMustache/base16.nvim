" Base16 https://github.com/voronianski/oceanic-next-color-scheme (https://github.com/chriskempson/base16)
" Scheme: OceanicNext
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('oceanicnext', '-', '_', 'g').'_'.&background
