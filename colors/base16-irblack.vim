" Base16 Timothée Poisot (http://timotheepoisot.fr) (https://github.com/chriskempson/base16)
" Scheme: IR Black
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('irblack', '-', '_', 'g').'_'.&background
