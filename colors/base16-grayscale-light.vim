" Base16 Alexandre Gavioli (https://github.com/Alexx2/) (https://github.com/chriskempson/base16)
...
" Tell them our name.
let g:colors_name = 'grayscale-light'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('grayscale-light', '-', '_', 'g').'_'.&background
