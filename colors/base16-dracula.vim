" Base16 Mike Barkmin (http://github.com/mikebarkmin) based on Dracula Theme (http://github.com/dracula) (https://github.com/chriskempson/base16)
" Scheme: Dracula
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('dracula', '-', '_', 'g').'_'.&background
