" Base16 Seth Wright (http://sethawright.com) (https://github.com/chriskempson/base16)
" Scheme: Google Light
...
" Tell them our name.
let g:colors_name = 'google-light'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('google-light', '-', '_', 'g').'_'.&background
