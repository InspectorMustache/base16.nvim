" Base16 Christopher Corley (http://christop.club/) (https://github.com/chriskempson/base16)
...
" Tell them our name.
let g:colors_name = 'summerfruit-light'
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('summerfruit-light', '-', '_', 'g').'_'.&background
