" Base16 Chris Kempson (http://chriskempson.com) (https://github.com/chriskempson/base16)
" Scheme: Cupcake
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('cupcake', '-', '_', 'g').'_'.&background
