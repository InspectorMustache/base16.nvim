" Base16 Alexandre Gavioli (http://github.com/Alexx2/) (https://github.com/chriskempson/base16)
" Scheme: Marrakesh
...
if get(g:, 'base16_airline', 0)
  let s:palette = substitute('marrakesh', '-', '_', 'g').'_'.&background
